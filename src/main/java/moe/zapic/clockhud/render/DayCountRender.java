...
public class DayCountRender {
    ...
    public static void render(MatrixStack matrices, float tickDelta, CallbackInfo ci) {
        ...
        setRenderStatus();
        DrawableHelper.drawCenteredTextWithShadow(matrices, mc.textRenderer, Text.translatable("text.clock-hud.new-day-tip", currentDay), mc.getWindow().getScaledWidth() / 2, 30, (TextOpacity << 24) + 0xffffff);
        matrices.pop();
